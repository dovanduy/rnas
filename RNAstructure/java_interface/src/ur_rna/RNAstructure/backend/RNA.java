...
public class RNA extends Thermodynamics {
  ...
  public int ProbKnot(int iterations, int MinHelixLength) {
    return RNABackendJNI.RNA_ProbKnot__SWIG_0(swigCPtr, this, iterations, MinHelixLength);
  }

  public int ProbKnot(int iterations) {
    return RNABackendJNI.RNA_ProbKnot__SWIG_1(swigCPtr, this, iterations);
  }

  public int ProbKnot() {
    return RNABackendJNI.RNA_ProbKnot__SWIG_2(swigCPtr, this);
  }

  public int ProbKnotFromSample(int iterations, int MinHelixLength) {
    return RNABackendJNI.RNA_ProbKnotFromSample__SWIG_0(swigCPtr, this, iterations, MinHelixLength);
  }

  public int ProbKnotFromSample(int iterations) {
    return RNABackendJNI.RNA_ProbKnotFromSample__SWIG_1(swigCPtr, this, iterations);
  }

  public int ProbKnotFromSample() {
    return RNABackendJNI.RNA_ProbKnotFromSample__SWIG_2(swigCPtr, this);
  }
  ...
  public int ReadDMS(String filename) {
    return RNABackendJNI.RNA_ReadDMS(swigCPtr, this, filename);
  }
  ...
  public String GetSequence() {
    return RNABackendJNI.RNA_GetSequence(swigCPtr, this);
  }
